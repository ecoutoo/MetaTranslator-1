    ...
    <body>
        ...
        <div class="container-fluid bg-1 text-center">
            ...
            <div class="col-lg-8 col-sm-10" style="vertical-align">
                <h4 class="margin" style="line-height: 1.5em"><br>INDEX HTML Welcome to our metaphor translation survey. 
                    <br><br><br> 
                    You will evaluate the translation quality of given sentences. It takes about 5 minutes to fill in the survey. You have to answer all the questions for each sentence. The survey is anonymous. Your answers will be recorded for academic research. It may be published on academic articles for research purposes.
                </h4>
                <br><br>
        ...
        <div class="container-fluid bg-3" style="text-align: center">    
            ...
            <div class="row">
                <div class="col-sm-4">
                    <p>Click Explanation on how to select incorrect words, translation. etc..</p>
                </div>
                <div class="col-sm-4"> 
                    <p>Explanation on how to get dictionnary definition for a word.</p>
                </div>
                <div class="col-sm-4"> 
