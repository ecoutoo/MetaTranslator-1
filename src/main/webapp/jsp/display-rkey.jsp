				...
				<div class="container">
					<div class="row">
						<div class="col-sm-2 col-xs-2">
							<div id="gtco-logo"><a href="index.html">MetaTranslator<sup>&trade;</sup></a></div>
						</div>
						<div class="col-xs-10 text-right fh5co-top-social">
							<ul class="gtco-social">
								...
								<li><a href="manager" id="manager"><i class="fas fa-sign-in-alt"></i></a></li>
							</ul>
						</div>
					</div>
				</div>
						...
						<div class="col-md-10 col-md-offset-1 text-center">
							<div class="dt js-height">
								<div class="dtc animate-box">
									<h3 align="center">Your Researcher ID is: <c:out value="${rkey}"/></h3><br>
									<!--<h3 class="gradient-text">Username <c:out value="${username}"/><br>Name <c:out value="${name}"/><br>Surname <c:out value="${surname}"/><br>Email <c:out value="${email}"/><br></h3><br> -->
								</div>
							</div>	
						</div>
					</div>
		...
		<!-- <div id="gtco-project">
			<div class="container">
				<div class="row row-pb-md">
					<div class="col-md-7">
						<h3>Our Work</h3>
						<p class="desc">Design is the creation of a plan or convention for the construction of an object or a system as in architectural blueprints.</p>
					</div>
				</div>
				<div class="row row-pb-md">
