...
COPY Sentences(internal_id, sentence) FROM 'C:\apache-maven-3.6.0\projects\MetaTranslator\src\main\database\corpora\VUA1\AwkParsingFinalResult.txt' DELIMITER '|' ENCODING 'latin1';
COPY Sentences(internal_id, sentence) FROM 'C:\apache-maven-3.6.0\projects\MetaTranslator\src\main\database\corpora\MOH1\MOHAWK.txt'  DELIMITER '|' ENCODING 'UTF-8';
COPY Sentences(internal_id, sentence) FROM 'C:\apache-maven-3.6.0\projects\MetaTranslator\src\main\database\corpora\FLA1\Affective_with_metaphors_pos.txt'  DELIMITER '|' ENCODING 'UTF-8';
COPY Sentences(internal_id, sentence) FROM 'C:\apache-maven-3.6.0\projects\MetaTranslator\src\main\database\corpora\FLA2\Affective_with_metaphors_neg.txt'  DELIMITER '|' ENCODING 'UTF-8';
...
ALTER SEQUENCE surveys_id_seq RESTART WITH 16328 INCREMENT BY 73;
